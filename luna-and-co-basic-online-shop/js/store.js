...
const PRODUCTS = [
  {
    ...
    sizing:{
      title:'Size guide',
      intro:'The Mira Tote is a roomy everyday carry. As a guide, it comfortably holds the following.',
      head:['Fits','Details'],
      rows:[
        ['Everyday essentials','Phone, wallet, keys, small pouch, water bottle'],
        ['Work','13-inch laptop, notebook, umbrella'],
        ['Strap drop','24 cm — sits comfortably on the shoulder'],
        ['Weight when empty','Approx. 420 g']
      ],
      tip:'Measurements are taken by hand, so allow a small variation of about 1&ndash;2 cm.'
    },
    img:'bag-tote'
  },
  {
    ...
    sizing:{
      title:'Size guide',
      intro:'A compact crossbody for the essentials only. Here is what fits comfortably.',
      head:['Fits','Details'],
      rows:[
        ['Everyday carry','Phone, card holder, keys, lip tint'],
        ['Not recommended for','Tablets, laptops, or water bottles'],
        ['Strap drop','Adjustable 45&ndash;58 cm'],
        ['Weight when empty','Approx. 210 g']
      ],
      tip:'If you like to carry a notebook or umbrella, the Mira Everyday Tote is the better fit.'
    },
    img:'bag-cross'
  },
  {
  ...
  },
  {
    ...
    sizing:{
      title:'Size guide',
      intro:'Two sizes, so you can pick the right burn time for your space.',
      head:['Size','Details'],
      rows:[
        ['4 oz','Approx. 25 hours burn &middot; suited to a bedside table or bathroom'],
        ['8 oz','Approx. 45 hours burn &middot; suited to a living room or larger bedroom'],
        ['Jar height','4 oz: 6 cm &middot; 8 oz: 8.5 cm'],
        ['Jar diameter','4 oz: 6 cm &middot; 8 oz: 7.5 cm']
      ],
      tip:'Trim the wick to about 5 mm before each use. This keeps the flame steady and makes the candle last longer.'
    },
    img:'life-candle'
  },
  {
  ...
  },
  {
    ...
    sizing:{
      title:'Size guide',
      intro:'The Everyday Notebook is a true A5 — small enough for a bag, big enough to write on comfortably.',
      head:['Spec','Details'],
      rows:[
        ['Page size','A5 &middot; 14.8 × 21 cm'],
        ['Cover','Linen-wrapped board, lightly padded'],
        ['Paper weight','100 gsm &middot; fountain-pen friendly'],
        ['Layout','Dot grid &middot; 5 mm spacing'],
        ['Thickness','Approx. 1.8 cm']
      ],
      tip:'Dot grid gives you the alignment of graph paper without the heavy lines — good for lists, sketches, and layouts alike.'
    },
    img:'life-notebook'
  },
  {
...
function navHTML(active){
  ...
  const main = link('index.html','Home') + link('shop.html','Shop') + link('how-to-order.html','How to Order') +
               link('about.html','About') + link('contact.html','Contact');
  return { links: main, drawer: main + '<a href="cart.html">Your Cart</a>' };
}
